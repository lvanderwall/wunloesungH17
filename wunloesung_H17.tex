...
\incfigs{a1d}{NWM für $t>t_S$ mit $R_i=R,\:C_i=C$. Ab e) ist $L=0\quad\arr\quad L\:\rightarrow$ \red{KS}}{a1d}

\noindent Mit der Vereinfachung $R_i=R,\:C_i=C$ werden die Teilnetze aus \Fref{a1a} und \Fref{a1d} parallel zu den festen Quellen $v(t)$ bzw. $j(t)$ identisch. Also haben beide NWMe die gleiche Eingangsimpedanz $\uZ_{in}$:
\[%
